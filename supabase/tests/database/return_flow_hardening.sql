...
select has_function(
    ...
    'create_return_report RPC should exist'
  );
select has_function(
    'public',
    'attach_return_photos',
    'attach_return_photos RPC should exist'
  );
...
select has_column(
    ...
    'return_reports',
    'photo_evidence',
    'return_reports table should have photo_evidence column'
  );
...
select results_eq(
    ...
    where schemaname = 'storage'
      ...
      and policyname = 'service_upload_only_public_buckets' $$,
      $$
    values (1) $$,
      'Strict service_upload_only_public_buckets policy should exist'
  );
