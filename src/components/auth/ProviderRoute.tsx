...
const ProviderRoute = ({ children }: ProviderRouteProps) => {
  ...
  const PendingOverlay = () => (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/45 backdrop-blur-[2px] px-4">
      <div className="bg-white/95 rounded-2xl shadow-lg p-8 max-w-lg text-center space-y-4 border border-amber-100">
