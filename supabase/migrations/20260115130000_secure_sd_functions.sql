...
REVOKE ALL ON FUNCTION public.issue_reservation(UUID, UUID, UUID, BOOLEAN, TEXT) FROM PUBLIC, anon, authenticated;
...
REVOKE ALL ON FUNCTION public.process_return(UUID, UUID, UUID, JSONB) FROM PUBLIC, anon, authenticated;
...
REVOKE ALL ON FUNCTION public.expire_stale_holds(int) FROM PUBLIC, anon, authenticated;
...
REVOKE ALL ON FUNCTION public.approve_provider(uuid) FROM PUBLIC, anon, authenticated;
